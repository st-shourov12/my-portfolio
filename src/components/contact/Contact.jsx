...
//                 <div className={`w-10 h-10 rounded-xl bg-linear-to-r ${card.color}
...
//                                 bg-white/5 border border-white/15 text-gray-400 text-lg
//                                 transition-all duration-300 hover:scale-110 hover:bg-white/10 ${s.color}`}>
//                     {s.icon}
//                   </a>
//                 ))}
//               </div>
...
//             {/* Availability card */}
//             <div className="bg-linear-to-br from-purple-900/40 to-pink-900/30 border border-purple-500/20
//                             rounded-2xl p-5 mt-1">
...
//             <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-7 md:p-8
//                             shadow-[0_0_40px_#6b00ff15]">
...
//                   className="w-full py-3.5 rounded-xl bg-linear-to-r from-purple-500 to-pink-500
//                              text-white font-semibold text-sm tracking-wide
//                              hover:opacity-90 hover:scale-[1.02] active:scale-[0.98]
//                              transition-all duration-300 shadow-lg shadow-purple-700/30
